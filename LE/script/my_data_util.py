...
class Loader(object):
    def __init__(self, data_file, cache_size, batch_size, device='cpu'):
        #self.tokenizer = BertTokenizer.from_pretrained(args.bert_model)
...
if __name__ == '__main__':
    ...
    args.data_dir = '../LE/train'
    args.pre = args.post = 0
    ##########
    args.bert_model ='../model/bert-large-uncased-vocab.txt'
    args.save_name = '../data/train.pt'
    ##########
